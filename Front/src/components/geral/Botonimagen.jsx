  ...
  return (
    ...
    <div className="row g-3">
      <div className="col">
        ...
        <img src="https://i.imgur.com/fWSpeZY.jpeg" className="img-fluid" alt="Button " onClick={()=> setMostrar("info1")} lang="150" width="150"/>
      </div>
      <div className="col">
        <img src="https://i.imgur.com/beWJ0Q6.jpeg" className="img-fluid" alt="Button 2" onClick={()=> setMostrar("info2")} lang="150" width="150"/>
      </div>
      <div className="col">
        <img src="https://i.imgur.com/EtAleZ2.jpeg" className="img-fluid" alt="Button 3" onClick={()=> setMostrar("info3")} lang="150" width="150"/>
      </div>
      <div className="col">
        <img src="https://i.imgur.com/FdA03W8.jpeg" className="img-fluid" alt="Button 4" onClick={()=> setMostrar("info4")} lang="150" width="150"/>
      </div>
      <div className="col">
        <img src="https://i.imgur.com/cVx5Iqc.jpeg" className="img-fluid" alt="Button 5" onClick={()=> setMostrar("info5")} lang="150" width="150"/>
      </div>
    </div>
    ...
    <div id="info1" className="info-container" style={{display:mostrar === "info1"?"flex":"none"}}>
      <div className="row">
        ...
        <div className="col-md-6 , d-flex justify-content-center align-items-center">
          <img src="https://i.imgur.com/fWSpeZY.jpeg" className="img-fluid" alt="Info 1" lang="200" width="200"/>
        </div>
      </div>
    </div>
    ...
    <div id="info2" className="info-container" style={{display:mostrar === "info2"?"flex":"none"}}>
      <div className="row">
        ...
        <div className="col-md-6 , d-flex justify-content-center align-items-center">
          <img src="https://i.imgur.com/beWJ0Q6.jpeg" className="img-fluid" alt="Info 2" lang="200" width="200"/>
        </div>
      </div>
    </div>
    ...
    <div id="info3" className="info-container" style={{display:mostrar === "info3"?"flex":"none"}}>
      <div className="row">
        ...
        <div className="col-md-6 , d-flex justify-content-center align-items-center">
          <img src="https://i.imgur.com/EtAleZ2.jpeg" className="img-fluid" alt="Info 3" lang="200" width="200"/>
        </div>
      </div>
    </div>
    ...
    <div id="info4" className="info-container" style={{display:mostrar === "info4"?"flex":"none"}}>
      <div className="row">
        ...
        <div className="col-md-6 , d-flex justify-content-center align-items-center">
          <img src="https://i.imgur.com/FdA03W8.jpeg" className="img-fluid" alt="Info 4" lang="200" width="200"/>
        </div>
      </div>
    </div>
    ...
    <div id="info5" className="info-container" style={{display:mostrar === "info5"?"flex":"none"}}>
      <div className="row">
        ...
        <div className="col-md-6 , d-flex justify-content-center align-items-center">
          <img src="https://i.imgur.com/cVx5Iqc.jpeg" className="img-fluid" alt="Info 5" lang="200" width="200"/>
        </div>
      </div>
    </div>
  </div>
