    ...
    return (
        <div className="container-fluid">
            <div className="container">
                ...
                <PrivacySection 
                    title="8. Contacto"
                    content={<p>Si tiene alguna pregunta o inquietud sobre esta Política de Privacidad, no dude en ponerse en contacto con nosotros a través de <strong>contacto@biomap.cl</strong> o Completa el formulario de contacto haciendo click en CONTACTO al final de nuestra página.</p>}
                />
            </div>
        </div>
    );
